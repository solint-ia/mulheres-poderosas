...
export const EVENT_DATE = '24 de Outubro de 2026';
export const EVENT_VENUE = 'Delmar Hotel';
export const EVENT_CITY = 'Aracaju/SE';
export const ORGANIZER_NAME = 'Maria Zélia Eventos e Representações';
